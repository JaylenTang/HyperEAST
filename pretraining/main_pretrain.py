...
if args.pretrain_mode == 'spatial':
    encoder = VisionTransformerForMIM(image_size=args.input_size, bands=band, num_classes=0, dim=64, depth=5, heads=4, mlp_dim=8, pretrain_mode='spatial')
elif args.pretrain_mode == 'spectral':
    encoder = VisionTransformerForMIM(image_size=args.input_size, bands=band, num_classes=0, dim=32, depth=5, heads=4, mlp_dim=4, pretrain_mode='spectral')
